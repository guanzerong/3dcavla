...
python experiments/robot/libero/run_libero_eval.py \
  --pretrained_checkpoint /data_all/gzr1/3dcavla/runs/openvla-7b+libero_spatial_cotdep+b8+lr-5e-05+lora-r32+dropout-0.0--image_aug--libero-spatial-cotdep-3dcavla--60000_chkpt \
